...
> 26.5%의 승률임에도 불구하고 **Sortino Ratio 21.01**을 기록한 것은, 추세 발생 시 **피라미딩(Pyramiding)** 통해 수익을 극대화하고 횡보장에서 **KAMA**로 손실을 최소화했음을 증명합니다.

### 💎 심화 퀀트 지표 (Advanced Quant Metrics)
...
### 🚀 폭발적 수익 창출 구간 (Upside Potential)
강력한 방어력(MDD)을 바탕으로, 추세 발생 시 피라미딩(Scaling-in)을 통해 극적인 수익을 창출합니다.

| 항목 (Profit Metric) | 수치 (Value) | 대상 종목 | 비고 |
| :--- | :--- | :--- | :--- |
| **단일 거래 최고 수익률** | **+6,411.58%** | **AVAX/USDT** | 21년 8월 불장 당시 피라미딩 풀베팅 결실 |
| **단일 거래 최고 수익금** | **$1,150.48** | **ETH/USDT** | 20년 7월 이더리움 변동성 분출 완벽 추종 |
| **월간 최고 수익 (Best Month)** | **+$1,390.94** | 2020.07 | 한 달 만에 초기 자산(+139%)을 넘어서는 폭발력 |
| **실전 라이브 최고 수익** | **+$134.22** | **BNB/USDT** | 26년 2월 5일 실전 API / 수동 익절 시너지 (1회 투입 $20 기준) |
