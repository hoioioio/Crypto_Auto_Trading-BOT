...
| :--- | :--- | :--- | :--- |
| **스트레스 테스트 1** <br>*(2022년 루나/FTX 파산)* | **4.62%** | **76.63%** | 코인 시장 최악의 폭락장에서도 숏(Sell) 포지셔닝 및 KAMA 방어 매커니즘으로 자산 완벽 보호 |
| **스트레스 테스트 2** <br>*(2025.10 마켓 크래시)* | **0.00%** | **14.62%** | 급락 구간 진입 전 시그널 선반영 및 관망으로 손실 원천 차단 (무결점 방어) |
| **스트레스 테스트 3** <br>*(2026 초반 급락장)* | **1.06%** | **35.11%** | 역대 최고점 달성 후 쏟아진 폭락(35%)을 불과 1%대의 낙폭으로 커트(Cut-off) |
